...
class UniqueInt {
    ...
    readNextItemFromFile(line) {
        ...
        // Remove any non-numeric characters, except for valid negative numbers
        const sanitizedLine = line.replace(/[^\d-]/g, '').trim();  // Keep digits and dashes only
        const number = parseInt(sanitizedLine, 10);

        // Check if it's a valid integer within the specified range
...
// Running the script
const inputDir = 'C:/Users/mucyo/OneDrive/Desktop/dsa/hw01/sample_inputs/';
const outputDir = 'C:/Users/mucyo/OneDrive/Desktop/dsa/hw01/sample_results/';
